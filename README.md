...
#### 개방형OS 사용자 중심의 전문지식 민주화 플랫폼은 개방형OS 사용자들이 지식검색을 손쉽게 할수 있게 지원하며 사용자와 기술지원 기업 사이에 복잡한 절차 없이 기술지원이 가능한 플랫폼이며, 사용자들의 활발한 커뮤니케이션을 지향하고 개발 초기부터 사용자들의 참여를 통해 함께 만들어 나가는 프로젝트 입니다.   
