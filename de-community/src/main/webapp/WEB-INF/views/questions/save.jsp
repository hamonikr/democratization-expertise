...
<!-- <script src="https://uicdn.toast.com/editor-plugin-color-syntax/2.0.0/toastui-editor-plugin-color-syntax.js"></script> -->
<style>
<!--
			...
			<div class="form-list">
				...
				<span>수정권한</span>
					<div class="checkbox-switch">
						<input type="checkbox" onchange="T.toggleToobarStatus()" value="${result.editauth}" name="editcheck" id="editcheck" class="input-checkbox" id="toolbar-active">
