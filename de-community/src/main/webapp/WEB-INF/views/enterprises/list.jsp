							...
							<div class="row">		
					        	...
					        	<c:forEach var="list" items="${data}" varStatus="status">
						        	<div class="col-md-3 col-sm-6 col-xs-12">
						         		<div class="info-box" onclick="javascript:location.href='/enterprises/activity/${list.enterpriseno}'" style="cursor: pointer;">
						            		<span class="info-box-icon bg-aqua">
						            			<c:if test="${list.enterpriseimg != null}">
													<img src="/upload/enterprises/${list.userprofileimg}">
												</c:if>
												<c:if test="${list.enterpriseimg == null}">
						            		...
						            		<div class="info-box-content">
						              		<span class="info-box-text">${list.enterprisename}</span>
						              		<span class="info-box-number">${list.enterpriseno }</span>
						            		</div>
						          	</div>
						        	</div>
								</c:forEach>
