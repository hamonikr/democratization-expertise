...
<div class="left-sidebar">
  <ul class="sidebar-nav">
    ...
    <li><a href="/enterprises/list"><i class="mdi mdi-apps"></i>Partners</a></li>
    <li><a href="/wiki/getStart"><i class="mdi mdi-file-word-box"></i>Wiki</a></li>
    <li><a href="/newsletters/subscribe"><i class="mdi mdi-format-page-break"></i>NewsLetters</a></li>
  </ul>
