               ...
               <table class="table table-hover text-nowrap" id="example2">
                 ...
                 <tbody>
                   <c:forEach var="list" items="${list}" varStatus="status">
					    <tr>
					      <td scope="row"><a href="#" onclick="view('${list.seq }')">${paginationInfo.totalRecordCount - ((paginationInfo.currentPageNo-1) * paginationInfo.recordCountPerPage + status.index) }</a></td>
					      <td><a href="#" onclick="view('${list.seq }')">${list.title }</a>${list.title }</a></td>
					      <td>${list.user_id}</td>
