                    ...
                    <table>
                        ...
                        <tbody>
                               ...
                               <div class="form-group">
                                   ...
                                   <c:forEach items="${codeList }" var ="a" varStatus="status">
                                   <input type="radio" name="section" id="section" />${a.codeName }
                                   </c:forEach>
                               </div>
                               </td>
                            </tr>
                               ...
                               <div class="form-group">
                                   <label for="titl" class="none"></label>
                                   <input type="text" name="subject" id="subject" placeholder="제목을 입력해주세요." value="${result.subject}" />
                               </div>
                               </td>
                            </tr>
                            <tr>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="writer_id" id="writer_id" placeholder="아이디를 입력해주세요." value="${result.writer_id}" />
                                </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="writer_name" id="writer_name" placeholder="이름을 입력해주세요." value="${result.writer_name}" />
                                </div>
                                </td>
                            </tr>
                            <%-- <tr>
                            ...
                            <tr>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="file1" id="file1" placeholder="" value="" />
                                </div>
                                </td>
                            </tr>
                            <tr>
