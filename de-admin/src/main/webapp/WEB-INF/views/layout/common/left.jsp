	...
	<nav class="mt-2">
		<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			...
			<c:if test="${UserSession.user_role eq 'S'}">
				<li class="nav-item" id="nav-item-signup-user"><a href="/signup/subUserEditForm.ivs" class="nav-link"> <img class="img_normal" src="/img/user.png"> <img class="img_over" src="/img/user_over.png">
						<p>
							회원 정보 관리<span class="badge badge-info right"></span>
						</p>
				</a></li>
			</c:if>
