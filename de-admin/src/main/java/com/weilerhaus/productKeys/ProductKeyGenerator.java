...
public abstract class ProductKeyGenerator<ED extends ProductKeyEncodingData> {
	...
	/* PRIVATE VARIABLES */
	/**
	 * This will store the number of HEXADECIMAL characters, based on the provided seed at generation time, that will
	 * appear at the beginning of the generated product-key thus partially defining its total length. <br />
	 * <br />
	 * This value must be positive and cannot exceeds 15; if it exceeds these bounds, it will be assigned a number
	 * between 1 and 15 inclusive. <br />
	 * <i>If this value were to be allowed to exceed 15, the HEXADECIMAL value will be too large for {@link Long} to
	 * parse it.</i>
	 */
	private final int seedCharLength;
	/**
	 * This will store the array of {@link ProductKeyEncodingData} elements that will be used to generate/verify
	 * product-keys. <br />
	 * <i> If a {@link ProductKeyEncodingData} element is <code>null</code>, that section of the product-key will not be
	 * validated. <br />
	 * However, it should be noted that the encoding will only work if all {@link ProductKeyEncodingData} elements are
	 * present. <br />
	 * <br />
	 * When including this in the client application code, omit some {@link ProductKeyEncodingData} elements by setting
	 * them to <code>null</code>. <br />
	 * This will ensure that the application code running on the clients device never has the entire logic for creating
	 * a product-key; if reverse engineered, they will only be able to create a product-key that will work on that
	 * build/version of your application. <br />
	 * Each new build/version of your client application should/could change the omitted {@link ProductKeyEncodingData}
	 * elements thus ensuring that if a previously cracked key worked, it won't in the new build/version. </i>
	 */
	private final ED[] productKeyEncodingData;
	/**
	 * This will store the {@link ProductKeySectionWorker} to be used by this {@link ProductKeyGenerator}.
	 */
	...
	/**
	 * This will store the {@link ProductKeyStylingWorker} to be used by this {@link ProductKeyGenerator}.
	 */
	private ProductKeyStylingWorker productKeyStylingWorker = null;
	/**
	 * This will store the {@link SeedAvailabilityWorker} to be used by this {@link ProductKeyGenerator}.
	 */
	 ...
	 * 
	 * @param seedCharLength The number of HEXADECIMAL characters, based on the provided seed at generation time, that
	 * will appear at the beginning of the generated product-key thus partially defining its total length. <br />
	 * <br />
	 * This value must be positive and cannot exceeds 15; if it exceeds these bounds, it will be assigned a number
	 * between 1 and 15 inclusive. <br />
	 * <i>If this value were to be allowed to exceed 15, the HEXADECIMAL value will be too large for {@link Long} to
	 * parse it.</i>
	 * @param productKeyEncodingData The array of {@link ProductKeyEncodingData} elements that will be used to
	 * generate/verify product-keys. <br />
	 * <i> If a {@link ProductKeyEncodingData} element is <code>null</code>, that section of the product-key will not be
	 * validated. <br />
	 * However, it should be noted that the encoding will only work if all {@link ProductKeyEncodingData} elements are
	 * present. <br />
	...
	/* PUBLIC METHODS */
	/**
	 * This method will get the number of HEXADECIMAL characters, based on the provided seed at generation time, that
	 * will appear at the beginning of the generated product-key thus partially defining its total length. <br />
	 * <br />
	 * This value must be positive and cannot exceeds 15; if it exceeds these bounds, it will be assigned a number
	 * between 1 and 15 inclusive. <br />
	 ...
	 * parse it.</i>
	 * 
	 * @return The number of HEXADECIMAL characters, based on the provided seed at generation time, that will appear at
	 * the beginning of the generated product-key thus partially defining its total length. <br />
	 * <br />
	 * This value must be positive and cannot exceeds 15; if it exceeds these bounds, it will be assigned a number
	 * between 1 and 15 inclusive. <br />
	 * <i>If this value were to be allowed to exceed 15, the HEXADECIMAL value will be too large for {@link Long} to
	 ...
	 * 
	 * @param productKey The product-key to be verified.
	 * @return The {@link ProductKeyState} that best describes the specified product-key.
	 */
					...
					try {
						...
						for (int n = 0; n < this.productKeyEncodingData.length; n++) {
							...
							if (this.productKeyEncodingData[n] != null) {
								tmpKeySection = cleanedProductKey.substring(currentKeyCharIndex,
										currentKeyCharIndex + 2);

								if (!tmpKeySection
										.equals(ProductKeyUtils.buildHexStr(2, this.getProductKeySectionWorker()
												.buildProductKeySection(seed, this.productKeyEncodingData[n])))) {
	 ...
	 * 
	 * @param seed The seed to use to ensure that the product-key is unique.
	 * @return The generated product-key. <br />
	 * <i>This will be <code>null</code> if the seed is not valid or this {@link ProductKeyGenerator} is not capable of
	 * creating a product key.</i>
	 * @throws ProductKeyGenerationException If the generation of the product-key failed.
	 */
		...
		try {
			...
			if ((this.productKeyEncodingData != null) && (this.productKeyEncodingData.length > 0)) {
				if (this.getProductKeySectionWorker() != null) {
					...
					if ((this.getSeedAvailabilityWorker() != null)
					...
					for (int n = 0; n < this.productKeyEncodingData.length; n++) {
						...
						keySb.append(ProductKeyUtils.buildHexStr(2, this.getProductKeySectionWorker()
								.buildProductKeySection(seed, this.productKeyEncodingData[n])));
					}
	...
	/* PROTECTED METHODS */
	/**
	 * This method will build the {@link ProductKeySectionWorker} to be used by this {@link ProductKeyGenerator}.
	 * 
	 * @return The {@link ProductKeySectionWorker} to be used by this {@link ProductKeyGenerator}.
	 */
	protected abstract ProductKeySectionWorker<ED> buildProductKeySectionWorker();

	/**
	 * This method will build the {@link ChecksumWorker} to be used by this {@link ProductKeyGenerator}.
	 * 
	 * @return The {@link ChecksumWorker} to be used by this {@link ProductKeyGenerator}.
	 */
	protected abstract ChecksumWorker buildChecksumWorker();

	/**
	 * This method will build the {@link BlacklistWorker} to be used by this {@link ProductKeyGenerator}.
	 * 
	 * @return The {@link BlacklistWorker} to be used by this {@link ProductKeyGenerator}.
	 */
	protected abstract BlacklistWorker buildBlacklistWorker();

	/**
	 * This method will build the {@link ProductKeyStylingWorker} to be used by this {@link ProductKeyGenerator}.
	 * 
	 * @return The {@link ProductKeyStylingWorker} to be used by this {@link ProductKeyGenerator}.
	 */
	protected abstract ProductKeyStylingWorker buildProductKeyStylingWorker();

	/**
	 * This method will build the {@link SeedAvailabilityWorker} to be used by this {@link ProductKeyGenerator}.
	 * 
	 * @return The {@link SeedAvailabilityWorker} to be used by this {@link ProductKeyGenerator}.
	 */
	...
	/* PRIVATE METHODS */
	/**
	 * This method will get the {@link ProductKeySectionWorker} to be used by this {@link ProductKeyGenerator}.
	 * 
	 * @return The {@link ProductKeySectionWorker} to be used by this {@link ProductKeyGenerator}.
	 */
	...
	/**
	 * This method will get the {@link ChecksumWorker} to be used by this {@link ProductKeyGenerator}.
	 * 
	 * @return The {@link ChecksumWorker} to be used by this {@link ProductKeyGenerator}.
	 */
	...
	/**
	 * This method will get the {@link BlacklistWorker} to be used by this {@link ProductKeyGenerator}.
	 * 
	 * @return The {@link BlacklistWorker} to be used by this {@link ProductKeyGenerator}.
	 */
	...
	/**
	 * This method will get the {@link ProductKeyStylingWorker} to be used by this {@link ProductKeyGenerator}.
	 * 
	 * @return The {@link ProductKeyStylingWorker} to be used by this {@link ProductKeyGenerator}.
	 */
	...
	/**
	 * This method will get the {@link SeedAvailabilityWorker} to be used by this {@link ProductKeyGenerator}.
	 * 
	 * @return The {@link SeedAvailabilityWorker} to be used by this {@link ProductKeyGenerator}.
	 */
