...
<div class="row">
	...
	<div id="input_div" class="col-12 " style="margin-top: .75rem;">
		<div class="callout callout-info row ">
			...
			<div class="col-6">
				<span class="float-right  "><a href="/main/index">Home</a> / 납품관리 현황</span>
			</div>
		</div>
	</div>
		                  ...
		                  <div class="row">
		                    ...
		                    <div class="col-7">
		                      <ul class="ml-4 mb-0 fa-ul text-muted">
		                      	<li class="small"><span class="fa-li"></span> <b>&nbsp;</b></li>
		                        <li class="small"><span class="fa-li"></span> <b>상품명 : </b>${list.product_name}</li>
		                        <li class="small"><span class="fa-li"></span> <b>계약번호 : </b>${list.business_code}</li>
		                        <li class="small"><span class="fa-li"></span> <b>라이센스 : </b>${list.sale_qy} 개 <a href="#" onclick="fnExcel('${list.business_code}','${list.demand_name}')" ><i class="fa fa-save"></i></a></li>
