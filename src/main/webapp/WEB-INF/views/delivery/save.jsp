...
function init(){
	if(${params != null && params != ""}){
		...
		var getInfo = '${getInfo}';
		var data = JSON.parse(getInfo);
		document.frm.supply_name.value = data.biznm;
		document.frm.supply_addr.value = data.addr1;
		document.frm.supply_bizno.value = data.bizno;
		document.frm.supply_cxfc.value = data.rprsntNm;
		document.frm.product_name.value = data.subject;
	}
