					...
					<div class="card-body row" style="padding: 1rem !important">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<div class="tel_div row">
									<input type="tel" class="form-control filter col-lg-2 inputs" placeholder="000" id="tele1" name="tele1" value="${bizResult.tele1}" maxlength=3 onKeyUp="chk_Number(this);"> 
									<span class="col-lg-1" > - </span> 
									<input type="tel" class="form-control filter col-lg-4 inputs" placeholder="0000" id="tele2" name="tele2" value="${bizResult.tele2}" maxlength=4 onKeyUp="chk_Number(this);"> 
									<span class="col-lg-1"> - </span> 
									<input type="tel" class="form-control filter col-lg-4" placeholder="0000" id="tele3" name="tele3" value="${bizResult.tele3}" maxlength=4 onKeyUp="chk_Number(this);" >
								</div>
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<div class="tel_div row">
									<input type="tel" class="form-control filter col-lg-2 inputs" placeholder="000"  id="fax1" name="fax1" value="${bizResult.fax1}" maxlength=3 onKeyUp="chk_Number(this);"> 
									<span class="col-lg-1"> - </span> 
									<input type="tel" class="form-control filter col-lg-4 inputs" placeholder="0000" id="fax2" name="fax2" value="${bizResult.fax2}" maxlength=4 onKeyUp="chk_Number(this);"> 
									<span class="col-lg-1"> - </span> 
									<input type="tel" class="form-control filter col-lg-4 inputs" placeholder="0000" id="fax3" name="fax3" value="${bizResult.fax3}" onKeyUp="chk_Number(this);" maxlength=4>
								</div>
							</div>
						</div>
					</div>
