...
<body>
					...
					<div class="btn-r">
						<div class="card-footer row">
							<div class="col-12 cont_btn_div">
								<button type="button" name="button" class="btn btn-primary purple" onClick="saveAddUserConfirm()">등록</button>
	...
	<div id="editPop" class="col-4 popup_layer">
		<div class="card-header">
			<h3 class="card-title">담당자 정보 수정</h3>
		</div>
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-3">부서</label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-3">직급</label>
				<div class="col-sm-8">
		...
		<div class="card-footer row">
			<div class="col-6 cont_btn_div">
				<button type="button" name="button" class="btn btn-primary purple" onClick="updateAddUserInfo()">수정</button>
		...
		<div class="row" id="content">
			...
			<div id="input_div" class="col-12">
				<div class="card">
					...
					<div class="card-body p-3 mb-3 row" style="padding: 1rem !important">
						<div class="col-lg-6">
							<div class="form-group">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<div class="tel_div row">
									<input type="tel" class="inputs form-control filter col-lg-2" id="user_hp1" name="user_hp1" value="${userResult.user_hp1}" maxlength=3> 
									<span class="col-lg-1"> - </span> 
									<input type="tel" class="inputs form-control filter col-lg-4" id="user_hp2" name="user_hp2" value="${userResult.user_hp2}" maxlength=4 > 
									<span class="col-lg-1"> - </span> 
									<input type="tel" class="inputs form-control filter col-lg-4" id="user_hp3" name="user_hp3" value="${userResult.user_hp3}" maxlength=4>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input type="password" class="form-control" placeholder="비밀번호" id="user_passwd" name="user_passwd" required maxlength="50">
							</div>
						</div>
			...
			<section class="content-header" style="padding: 2px .5rem;">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-12">
							<h5>추가 담당자 정보</h5>
...
<form name="userMngrFrm" id="userMngrFrm" method="POST">
	<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
</form>