...
.maincontent .card-header { padding: 2rem 1.5rem 1rem 1.5rem }
...
.maincontent .card-body .list-unstyled { padding: 1rem 1.5rem 0 1.5rem }
...
.card-body.p-0.row .col-6 { margin-bottom: 1em!important }
</style>
	              	...
	              	<div class="col-6">
		                  ...
		                  <c:forEach items="${notice }" var="item" varStatus="status">
			                  <c:if test="${ status.count < 4 }">
			                  	<li>
									<span class="dash_card_text1">- ${item.title }</span>
