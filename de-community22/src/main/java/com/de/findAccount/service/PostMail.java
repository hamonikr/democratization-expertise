...
public class PostMail {
	...
	public static String inviteMail(Account vo) {
		...
		String subject = "임시비밀번호를 발급해드렸습니다. 비밀번호를 재설정해주세요"; // 제목
		String from = "ivsnoti@gmail.com"; // 보내는 메일
		String fromName = "admin:de-community"; // 보낸 사람 표기
		...
		try {
			...
			String content = "";
			content += "<table><tr><th>임시 비밀번호 입니다.</th><th>로그인 후 재설정해주세요</th></tr>"+" <tr>"+vo.getUser_password() +" </tr>";
